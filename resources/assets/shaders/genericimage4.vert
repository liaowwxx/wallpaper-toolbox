...
#if PRELIGHTING
	// Must use deformed localPos (morph/skinning); raw `position` would ignore SKINNING and hide puppets.
#if PRELIGHTINGDUALVERTEX
	gl_Position = mul(vec4(a_PositionC1, 1.0), g_ModelViewProjectionMatrix);
#else
